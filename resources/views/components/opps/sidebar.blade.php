    ...
    <nav class="px-4 mt-2 space-y-1">
        ...
        <a href="{{ route('laporan.masuk-bencana') }}"
           class="block px-3 py-2 rounded-lg text-white text-sm
                  {{ request()->routeIs('laporan.masuk-bencana', 'laporan.show', 'laporan.edit', 'laporan.edit-lokasi') ? 'bg-white/10 font-bold text-white' : 'hover:bg-white/5' }}">
        ...
        <a href="{{ route('laporan-penanganan-balai') }}"
           class="block px-3 py-2 rounded-lg text-white/90 text-sm
            ...
            Laporan Bencana Unit Pelaksana
        </a>
