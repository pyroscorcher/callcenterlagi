{{--
    Komponen: <x-balai.laporan-table :type="'bencana-terkini'" :laporans="$bencanaTerkini" />
              <x-balai.laporan-table :type="'laporan-masyarakat'" :laporans="$laporanMasyarakat" />

    Props:
    - type     : 'bencana-terkini' | 'laporan-masyarakat' -> menentukan tombol Aksi
    - laporans : koleksi LaporanMasyarakat (paginator ok)
--}}
@props([
